...
else    if (this.pageNumber == 0 && this.showButtoons.length == 1) 
      this.fillValues(this.pageNumber + 1, this.pageNumber + this.ADDRESS_OFFICER_BTN_SIZE);

     else if (this.showButtoons.length == 1)    // when the page is not zero and we don't want to switch the array it will fill the same value of pages
